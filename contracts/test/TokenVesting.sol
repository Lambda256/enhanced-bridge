...
contract TokenVesting {
  ...
  constructor(SideToken _sideToken, address _recipient, uint256 _vestedAmount, uint256 _start, uint256 _cliffInDays, uint256 _durationInDays, uint256 _intervalInDays) {
